...
#define FT_SUBGLYPH_FLAG_USE_MY_METRICS      0x200
   ...
   *
   *   Only non-variable format identifiers are listed in this
   *   enumeration. This is because once support for variable `COLR` v1 fonts
   *   is implemented, interpolation is performed dependent on axis
   *   coordinates configured on the @FT_Face through
   *   @FT_Set_Var_Design_Coordinates and static interpolated values are
   *   returned for each respective format.
   */
