...
FT_BEGIN_HEADER
   ...
   *     configured on the FT_Face into account.  Reset scale to 1 and
   *     remove transforms configured using FT_Set_Tranfsorm in order to
   *     retrieve clip box in font units.
   *
   * @return:
   ...
   */
  typedef FT_Bool
  ( *TT_Get_ClipBox_Func )( TT_Face   face,
                            FT_UInt   base_glyph,
                            FT_BBox*  clip_box );
