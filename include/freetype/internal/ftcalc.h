...
#define FT_MulFix( a, b )  FT_MULFIX_ASSEMBLER( (FT_Int32)(a), (FT_Int32)(b) )
   ...
   *
   * @note:
   *   This function is currently used for the scaled delta computation for
   *   variation stores. It internally uses 64-bit data-types when available,
   *   otherwise emulates 64-bit math using 32-bit operations, which produces a
   *   correct result but most likely at a slower performance as the int64_t
