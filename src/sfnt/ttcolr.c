...
#define COLR_HEADER_SIZE                 14U
  ...
  typedef struct  Colr_
  {
    ...
    /* Paint tables start at the minimum of the end of the LayerList and the end
     * of the BaseGlyphList, record this location in a field here for safety
     * checks when accessing paint tables. */
